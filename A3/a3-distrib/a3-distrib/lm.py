...
def run_sanity_check(lm, vocab_index):
    ...
    for context in contexts:
        # print("SANITY context ", context)
        for next_seq in next_seqs:
            # print("LM sequence ", next_seq)
